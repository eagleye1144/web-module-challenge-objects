...
function createMenuItem(item, cost, type){
    /*Your code here*/
   return {name: item, price: cost,category: type};
}
...
const omelet = createMenuItem('omelet', 9, 'breakfast');
const chickenAlfredo = createMenuItem('chickenAlfredo', 10, 'dinner');
...
export const burger = {
  ...
  discount: function (string){
    if (string === 'teacher' || string === 'student'){
      ...
      let publicDiscount = this.price * 0.10;
      return this.price - publicDiscount;
    }
  }
}
...
reviews.push({name:'Mitch', rating: 5, feedback: 'This place is great'})
console.log(reviews);
